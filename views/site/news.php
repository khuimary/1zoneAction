...
<html lang="en">
  ...
  <title>NEWS | 1 ZONEMMA NEWS</title>
  </head>
  <body>
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#sports" id="Sports">sports</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#technology" id="technology">Technology</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#entertainment" id="entertainment">Entertainment</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#local" id="local">Local</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#science" id="science">Science</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#us" id="Us">U.s</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" aria-current="page" href="#world" id="World">World</a>
                    </li>
